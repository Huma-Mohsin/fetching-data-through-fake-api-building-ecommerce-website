        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap bg-pink-100 rounded-lg shadow-lg">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 p-6">
              <h2 className="text-3xl font-bold text-indigo-600 tracking-widest mb-4">{res.title}</h2>
              <h1 className="text-gray-600 text-xl title-font font-semibold mb-4">{res.category}</h1>
              <div className="flex mb-4 items-center">
                ...
                <span className="text-gray-600 ml-3">{res.rating.rate} Reviews</span>
              </div>
              <p className="leading-relaxed text-gray-900 text-lg">{res.description}</p>
              ...
              <div className="flex items-center justify-between">
                <span className="title-font font-semibold text-2xl text-gray-900">${res.price}</span>
